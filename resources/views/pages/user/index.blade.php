...
{{--                                                  <source srcset="/assets/images/{{$obCategory->image}}" type="image/webp">--}}
                                              ...
                                              @endif
                                              <h2 class="woocommerce-loop-category__title">{{$obCategory->name}}</h2>
                                            </a>
                                        </div>
                                      @endforeach
                                    </div>
                                            ...
                                            @foreach($obNewProductList as $obProduct)
                                              ...
                                              <div class="product">
                                                  ...
                                                  <a href="{{route('shop_show_product',[ $obProduct->category->slug, $obProduct->slug] )  }}" class="woocommerce-LoopProduct-link">
                                                    ...
                                                    <span class="price">
                                                        <ins>
                                                            <span class="amount">{{number_format($obProduct->price, 2)}}</span>
                                                        </ins>
                                                        @if($obProduct->old_price)
                                                          <del>
                                                              <span class="amount">{{number_format($obProduct->old_price, 2)}}</span>
                                                          </del>
                                                        @endif
